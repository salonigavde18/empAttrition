...
def data_preprocessing(task_1a_dataframe):
	...
	#################	ADD YOUR CODE HERE	##################
	emp_data = pd.read_csv('C:/Users/salon/Downloads/Task_1A/Task_1A/task_1a_dataset.csv')
	emp_data.head()
	emp_data.shape
	emp_data.info()
	...
	emp_data['City'] = le.fit_transform(emp_data['City'])
	emp_data['EverBenched'] = le.fit_transform(emp_data['EverBenched'])
	emp_data.head()
	encoded_dataframe = emp_data.drop(labels=['JoiningYear', 'City'], axis=1)
